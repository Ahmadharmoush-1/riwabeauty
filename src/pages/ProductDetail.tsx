...
const ProductDetail = () => {
  ...
  const { addToCart, items } = useCart(); // ✅ FIXED: removed updateQuantity
    ...
    <Layout>
      <div className="container mx-auto px-4 py-6 md:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-16">
          {/* Image */}
          <div className="aspect-square rounded-3xl overflow-hidden bg-accent/50 shadow-card animate-fade-in">
            <img
              src={product.image}
              alt={product.name}
